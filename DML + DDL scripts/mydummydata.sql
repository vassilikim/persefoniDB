...
INSERT INTO `Book` (`title`, `publisher`, `ISBN`, `page_number`, `summary`, `copies`, `image`, `lang`, `keywords`, `school_ID`) 
VALUES ('Book 4', 'Efrain', 'e5e79a46-61a7-3a1c-9648-20f3f71945e7', 100, 'Natus sunt qui et iure. Eaque voluptate perspiciatis voluptatem. Accusamus perferendis similique optio fugit quas rerum. Rerum ipsam ut reiciendis nulla illum quos ex.', 25, 'tmp//0a1b1e5e8acaa3c2664ba84421da921f.jpg', 'Greek', '[one, two, three]', 1);
INSERT INTO `Book` (`title`, `publisher`, `ISBN`, `page_number`, `summary`, `copies`, `image`, `lang`, `keywords`, `school_ID`) 
